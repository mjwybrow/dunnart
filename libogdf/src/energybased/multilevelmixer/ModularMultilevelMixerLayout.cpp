...
ModularMultilevelMixer::ModularMultilevelMixer()
    : m_oneLevelLayoutModule(0),
	m_postLayoutModule(0),
	m_finalLayoutModule(0), 
	m_multilevelBuilder(0), 
	m_initialPlacement(0), 
	m_times(1), 
	m_fixedEdgeLength(-1.0f), 
	m_fixedNodeSize(-1.0f), 
	m_postIterations(-1),
	m_postTimeFactor(-1.0f),
	m_postAfterEveryStep(false),
