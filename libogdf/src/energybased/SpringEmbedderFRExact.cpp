...
//#if defined(OGDF_ARCH_X86) || defined(OGDF_ARCH_X64)
...
SpringEmbedderFRExact::SpringEmbedderFRExact()
{
	...
	// values below 0.99 and above 0.995 seem to be useless
	m_coolFactor_x = 0.995;
	m_coolFactor_y = 0.995;
...
void SpringEmbedderFRExact::mainStep(ArrayGraph &C)
{
	...
	const double c_rep   = 0.2 * kSquare; // 0.2 = factor for repulsive forces as suggested by Warshal

	const double minDist       = 100*DBL_EPSILON;
