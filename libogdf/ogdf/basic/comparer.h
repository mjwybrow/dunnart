 ...
 * last checkin:
 *   $Author: chimani $ 
 *   $Date: 2008-01-26 15:22:38 +0100 (Sat, 26 Jan 2008) $ 
 ***************************************************************/
...
{
public:
        static bool less(const E &x, const E &y) { OGDF_UNUSED(x); OGDF_UNUSED(y); OGDF_THROW(NoStdComparerException); }
        static bool leq(const E &x, const E &y) { OGDF_UNUSED(x); OGDF_UNUSED(y); OGDF_THROW(NoStdComparerException); }
        static bool greater(const E &x, const E &y) { OGDF_UNUSED(x); OGDF_UNUSED(y); OGDF_THROW(NoStdComparerException); }
        static bool geq(const E &x, const E &y) { OGDF_UNUSED(x); OGDF_UNUSED(y); OGDF_THROW(NoStdComparerException); }
        static bool equal(const E &x, const E &y) { OGDF_UNUSED(x); OGDF_UNUSED(y); OGDF_THROW(NoStdComparerException); }
};
