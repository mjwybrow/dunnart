...
Build OGDF (Visual C++ 8.0 Compiler [Windows]):

  1. Execute the python script makeVCProj.py to generate a
     Visual Studio 2005 project file ogdf.vcproj.

  2. Open this project with Visual Studio 2005 and call
     build.

OGDF also contains some optional features which require COIN
Osi as LP solver. It is also possible to generate project
files for Visual Studio 2003.
