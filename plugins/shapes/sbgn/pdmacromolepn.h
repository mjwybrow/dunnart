...
#ifndef PDMACROMOLEPN_H
#define PDMACROMOLEPN_H

#include "pdepn.h"

using namespace dunnart;

// Macomolecule EPN glyph
...
//  Can be multimeric.
class MacromolEPN: public PDEPN
{
public:
//    MacromolEPN(Label *t, bool cb, Label *cl, bool m) : PDEPN(t, cb, cl, m) {}
    MacromolEPN(QString t, bool cb, QString cl, bool m) : PDEPN(t, cb, cl, m) {}
    ...
    QPainterPath singleShape(double w, double h, int r) const;
    QPainterPath frontMultimerShape(double w, double h, int r) const;
    QPainterPath backMultimerShape(double w, double h, int r) const;
    QAction* buildAndExecContextMenu(QGraphicsSceneMouseEvent *event, QMenu& menu);
};

#endif // PDMACROMOLEPN_H
